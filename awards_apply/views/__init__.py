...
from awards_apply.views.award_view import (AwardView,
                                           RecordView, get_application_by_id,
                                           get_award_by_id, home)
from awards_apply.views.award_view import finish_award, award_application,available_awards  # noqa; noqa
...
from awards_apply.views.group_view import (GroupManageView, GroupUserView,
                                           GroupView, GroupAllView,GroupInvite)
