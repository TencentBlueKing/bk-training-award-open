# Generated by Django 2.2.6 on 2022-03-26 11:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_state',
                 models.IntegerField(choices=[(0, '待评审'), (1, '评审通过'), (2, '评审不通过'), (3, '草稿')], default=3,
                                     verbose_name='评审状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_state',
                 models.IntegerField(choices=[(0, '评审中'), (1, '已结束')], default=0, verbose_name='奖项状态')),
            ],
        ),
        migrations.CreateModel(
            name='Group',
