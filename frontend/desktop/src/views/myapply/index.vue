<template>
    <div class="">
        <!-- <div>
            <span class="depart-name">部门名称</span>
            <bk-search-select clearable :show-popover-tag-change="true" style="display: inline-block;width: 150px;" v-model="value"></bk-search-select>
        </div> -->
        <!-- <div class="input-demo">
            <span>部门名称</span>
            <bk-input :clearable="true" v-model="value" style="display: iniline-box"></bk-input>
            <span>奖项名称</span>
            <bk-input :clearable="true" v-model="value" style="display: iniline-box"></bk-input>
        </div> -->
        <div>
            <bk-table style="margin-top: 15px;"
                ...
                <bk-table-column label="操作">
                    <template slot-scope="props">
                        ...
                        <!-- <div v-if="props.row.status === '已通过'" style="width: 100%">--</div> -->
