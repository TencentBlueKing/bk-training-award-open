    ...
    <div class="">
        ...
        <div>
            <bk-table style="margin-top: 15px;"
                ...
                <!-- <bk-table-column label="评审内容" style="">
                    <template slot-scope="props" style="height: 15px;margin-top: 10px;">
                        <textarea rows="2" cols="45" v-model="props.row.text" style="margin-top: 10px;margin-bottom: 10px;">默认内容</textarea>
                    </template>
                </bk-table-column> -->
            </bk-table>
        </div>
